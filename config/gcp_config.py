"""GCP resource names — single source of truth for the whole project."""
import os
...
CHECKPOINTS_BUCKET = f"{PROJECT_ID}-checkpoints"
STAGING_BUCKET     = f"{PROJECT_ID}-dataproc-staging"
